...
param = {'task': 'train', 'boosting': 'gbdt', 'objective': 'binary', 'metric': 'auc', 'num_leaves': 21, 'min_data_in_leaf': 1, 'learning_rate': 0.09750911469617053, 'max_depth': 25, 'feature_fraction': 0.762062855334688, 'bagging_freq': 3, 'bagging_fraction': 0.3387113270618908, 'use_missing': True, 'nthread': 4, 'lambda_l1': 0.674951641198698, 'lambda_l2': 0.3739576064972031, 'max_bin': 181}
...
hidden_prediction_pd.to_excel("Model_5_3_year_hidden_prediction.xlsx")
...
'red' ,# (-0.031562256489936484, -0.04232812058041369, -0.020796392399459275) continuous Choice_reaction_time_Ex5
...
'green' ,# (0.0028116968551180964, 0.001358223773337043, 0.0042651699368991495) categorical TBI_LOC
'red' ,# (-0.013018761676287837, -0.01975631800091666, -0.0062812053516590055) continuous BMIX4
'red' ,# (-0.003413915194304468, -0.0052137837894731184, -0.0016140465991358172) categorical HYPBP1
...
myorder = [ 1,3,5,9,6,4,11,2,0,7,8,10 ]
...
plt.savefig("VIA_model3d.png", dpi=dpi_val, bbox_inches='tight')
plt.show()
...
plt.savefig("model3d_var_direct.png", dpi=dpi_val, bbox_inches='tight')
...
plt.savefig("CM_model3d.png", dpi=dpi_val, bbox_inches='tight')
...
plt.savefig("new_model3d_var_direct.png", dpi=dpi_val, bbox_inches='tight')
...
plt.savefig('xDENLV4_pred_model3d.png', dpi=dpi_val, bbox_inches='tight')  # saves the current figure
plt.show()
...
plt.plot(y,x, ':b',color='grey', label='Threshold Value')
plt.legend(numpoints=1, loc=1)
plt.savefig('xDENLV4_pred_model3d_V2.png', dpi=dpi_val, bbox_inches='tight')  # saves the current figure
plt.show()
...
pyplot.plot(ns_fpr_no, ns_tpr_no, marker='.',  label='Final Model: Cases-1, LB_No (AUC=0.909) ')
pyplot.plot(lr_fpr_no, lr_tpr_no, linestyle='--',label='Baseline Model: Cases, LB_No (AUC=0.68) ')

pyplot.plot(ns_fpr, ns_tpr, marker='.', label='Final Model: Cases-1, LB_No, LB_Unknown (AUC=0.762) ')
...
plt.savefig('AUC_comparison_3_year.png', dpi=dpi_val, bbox_inches='tight')  # saves the current figure
...
hidden_prediction_pd.to_excel("Model_5_3_year_hidden_predictionv2.xlsx")
...
objects3 =('Simple Reaction Time (SRT)',
...
feature_imp =pd.DataFrame({'Value': performance,  'Feature': objects3})
feature_imp


plt.figure(figsize=(10, 3))
sns.barplot(x="Value", y="Feature", data=feature_imp, palette='gray')
#plt.title('Variable Importance Analysis',  fontsize=16)
plt.xlabel('Gain Importance')
plt.ylabel('')
plt.tight_layout()
plt.savefig('3_year_Final_variable_importance.eps', format='eps', dpi=600,  bbox_inches='tight')
...
plt.ylabel('')
plt.tight_layout()
plt.savefig('3_year_Final_variable_importance.png', format='png', dpi=600,  bbox_inches='tight')
...
#ax.set_title('Variable Importance Analysis')
plt.yticks(fontsize=12, weight = 'bold')
plt.savefig("VIA_model3d_same_color.png", dpi=dpi_val, bbox_inches='tight')
plt.show()
...
#ax.set_title('Variable Importance Analysis')
plt.yticks(fontsize=12, weight = 'bold')
plt.savefig("VIA_model3d_same_color.eps",format='eps',  dpi=dpi_val, bbox_inches='tight')
plt.show()
...
#ax.set_title('Variable Importance Analysis')
plt.yticks(fontsize=12, weight = 'bold')
plt.savefig("VIA_model3d_same_color_V2.png", dpi=dpi_val, bbox_inches='tight')
plt.show()
...
#ax.set_title('Variable Importance Analysis')
plt.yticks(fontsize=12, weight = 'bold')
plt.savefig("VIA_model3d_same_color_V2.eps",format='eps',  dpi=dpi_val, bbox_inches='tight')
plt.show()
